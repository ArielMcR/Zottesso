                ...
                <form action="cadFun.php" method="post" autocomplete="on">
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="Digite o sobrenome do funcionário" required
                                name="sobrenome">
                        </div>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="Digite o telefone(00) 0000-0000" name="telefone" required
                                class="form-control" onkeypress="$(this).mask('(00) 0000-00009')">
                        </div>
                    </div>
                    <div class="button">
