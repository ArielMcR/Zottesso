                ...
                <form action="alteracao.php" method="post" autocomplete="on">
                    ...
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="Digite o mês da venda" value="<?=$linha["Mês"]?>" required
                                list="mesdoano" name="mês">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="Digite o valor liquído do mês"
                                value="<?=$linha["valorLiquido"]?>" required name="valorLiquido" min="0">
                        </div>
                        <div class="input-box">
                            <span class="details">Valor Bruto</span>
                            <input type="number" placeholder="Digite o valor bruto do mês"
                                value="<?=$linha["valorBruto"]?>" name="valorBruto" required min="0">
                        </div>
                        <div class="input-box">
